...
run_get_data = BashOperator(
    ...
    bash_command="python3 /home/hadoop/mastodon/extraction_data.py",
    dag=dag,
)
...
run_mapreducer = BashOperator(
    ...
    bash_command="python3 /home/hadoop/mastodon/wordcounter.py /home/jane/mastodon/sample.json > ./output.txt",
    dag=dag,
)

run_inset_hbase = BashOperator(
    task_id='insert_into_hbase',
    bash_command='python3 /home/hadoop/mastodon/connection.py',
    dag=dag
)
